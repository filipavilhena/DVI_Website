...
let allFilterValues = {
  ...
  5: ["anyone", "members/clients", "students", "staff/workers", "event participants", "guest artists"],
  6: ["one person", "multiple people", "one or multiple"],
  7: ["voluntary", "involuntary"],
  8: ["intended", "emergent"],
  9: ["anytime", "in specific moments", "design process"],
  10: ["anywhere", "street", "events", "home/private environment", "museums/galleries", "establishments", "work place"],
  11: ["free", "physical materials", "mobile device", "computer", "installation"],
  12: ["text", "object manipulation", "drawing or writing", "data", "paramethers/options12", "audio or video capture12", "image"],
  13: ["content variation", "shape variation", "color variation", "position", "combination", "repetition", "rotation", "scaling"],
  14: ["logotype", "symbol", "system", "system´s element"],
  15: ["element creation", "element conjugation", "reactivity", "paramether/option manipulation"],
